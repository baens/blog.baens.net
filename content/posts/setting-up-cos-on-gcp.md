...
All source code is [hosted on github](https://github.com/baens/code-examples-blog.baens.net/tree/cos-gcp-setup) as well so you don't have to retype if you don't want too.
...
All of this code and examples are [hosted on my github account](https://github.com/baens/code-examples-blog.baens.net/tree/cos-gcp-setup).
